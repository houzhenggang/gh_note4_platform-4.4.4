...
// Step 2: method stubs.
static void DidRegister(JNIEnv* env, jobject jcaller,
    jlong nativePushProviderAndroid,
    jint result,
    jobject pushRegistration,
    jlong requestId) {
  PushProviderAndroid* native =
      reinterpret_cast<PushProviderAndroid*>(nativePushProviderAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "DidRegister");
  return native->DidRegister(env, jcaller, result, pushRegistration, requestId);
}

static void DidUnregister(JNIEnv* env, jobject jcaller,
    jlong nativePushProviderAndroid,
    jint result,
    jlong requestId) {
  PushProviderAndroid* native =
      reinterpret_cast<PushProviderAndroid*>(nativePushProviderAndroid);
  CHECK_NATIVE_PTR(env, jcaller, native, "DidUnregister");
  return native->DidUnregister(env, jcaller, result, requestId);
}
...
static const JNINativeMethod kMethodsPushProvider[] = {
    { "nativeDidRegister",
"("
"J"
"I"
"Lcom/sec/android/app/sbrowser/webpushnotifications/model/PushRegistration;"
"J"
")"
"V", reinterpret_cast<void*>(DidRegister) },
    { "nativeDidUnregister",
"("
"J"
"I"
"J"
")"
"V", reinterpret_cast<void*>(DidUnregister) },
};
...
static bool RegisterNativesImpl(JNIEnv* env) {
  ...
  const int kMethodsPushProviderSize = arraysize(kMethodsPushProvider);

  if (env->RegisterNatives(g_PushProvider_clazz,
                           kMethodsPushProvider,
                           kMethodsPushProviderSize) < 0) {
    jni_generator::HandleRegistrationError(
        env, g_PushProvider_clazz, __FILE__);
    return false;
  }
