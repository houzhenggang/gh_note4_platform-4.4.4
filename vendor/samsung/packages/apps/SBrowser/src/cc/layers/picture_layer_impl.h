...
class CC_EXPORT PictureLayerImpl
 ...
 protected:
  ...
  bool ShouldHaveLowResTiling() const {
    ...
    return ( should_use_low_res_tiling_ || should_use_low_res_tiling_on_fling_ ) && !use_gpu_rasterization();
#else
    return should_use_low_res_tiling_ && !use_gpu_rasterization();
#endif
#else
#if defined(S_LOW_LES_ON_FASTSCROLL)
    return ( should_use_low_res_tiling_ || should_use_low_res_tiling_on_fling_ ) && !should_use_gpu_rasterization();
#else
    return should_use_low_res_tiling_ && !should_use_gpu_rasterization();
#endif
#endif
  }
...
#if defined(S_LOW_LES_ON_FASTSCROLL)
  bool should_use_low_res_tiling_on_fling_;
#endif
