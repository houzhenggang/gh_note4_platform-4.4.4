...
LayerTreeSettings::LayerTreeSettings()
    : impl_side_painting(false),
      ...
      scrollbar_linear_fade_delay_ms(1000),
      scrollbar_linear_fade_length_ms(16),
      ...
      //samsung change : decrease max_tiles_for_interest_area 128 to 64 for ZoomOut FPS problem.
      max_tiles_for_interest_area(64),
