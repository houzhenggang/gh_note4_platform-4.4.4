...
class LayerTreeHostImplClient {
 public:
  ...
  virtual void SetContentTopOffsetToMainThread(float offset) {}
  #endif
  ...
  virtual void DeferCommitsOnImplThread(bool active) {}
#endif
 protected:
...
class CC_EXPORT LayerTreeHostImpl
 ...
 public:
  ...
  void SetScrollbarRequestCount(bool increase_count);
  int GetScrollbarRequestCount();
#endif
...
#endif
#if defined(S_DEFER_COMMIT_ON_GESTURE)
  void SetDeferCommitOnImpl(bool defer);
#endif
 ...
 public:
  ...
  bool faste_fling() const { return fast_fling_; }
#endif
  ...
  virtual void SetTopControlsHeight(int top_controls_height) OVERRIDE;
#endif
#if defined(S_SET_SCROLL_TYPE)
   virtual void SetScrollType(int type) OVERRIDE;
#endif
 protected:
  LayerTreeHostImpl(
      const LayerTreeSettings& settings,
 ...
 private:
...
#if defined(S_DEFER_COMMIT_ON_GESTURE)
  void DeferCommitsOnGesture(bool defer_commits);
#endif
  ...
  gfx::Size new_viewport_size_;
  bool viewport_changed_;

#if defined(S_LOW_LES_ON_FASTSCROLL)
  gfx::Vector2dF accumulated_fling_scroll_;
  bool fast_fling_;
#endif
// SAMSUNG CHANGE : Check for scrolling or fling
  ...
  bool is_end_of_page_;
  bool prev_is_end_of_page_;
#endif
#if defined(S_SCROLLBAR_LESS_UPDATE)
  bool schedule_to_hide_scrollbar;
  int scrollbar_request_counter_;
#endif
