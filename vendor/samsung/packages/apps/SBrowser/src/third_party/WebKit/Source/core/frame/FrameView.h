...
public:
    ...
    ScrollBehavior getScrollBehavior() { return m_scrollBehavior; }
    #else
    ...
    void setContentTopOffset(float) OVERRIDE;
    float getContentTopOffset() OVERRIDE;
#endif
    ...
    bool isSoftBmpCaptured() {return m_softBitmapValidCapture; }
#endif
