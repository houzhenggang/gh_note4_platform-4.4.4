...
#	     'S_PLM_P140607_01108=1', # Progress bar blinking fix
	     ...
	     'S_PLM_P141007_00217=1', #  Preventive Null Check For Avoiding Crash.
...
#	    'SBROWSER_QC_OPTIMIZATION_PRECREATE_RENDERER=1', #QCOM Patch Precreate render process
            ...
            'S_CHECK_CERTIFICATE_REVOCATION=1', # certificate_revocation
...
#            'EGLIMAGE_RENDERTARGET = 1',#webxprt performance patch from QC with necessary modification from sbrowser side
            ...
            'S_SAMSUNG_CLIENT_CERT_POLICY=1', # do not use stored certificate with null if it is main frame request
            ...
            'S_PROXY_BYPASS_RULES=1', # fix proxy bypass issue
            ...
            'S_P140916_01715=1',#touch event rects are not properly calculated corrected the same
             #'S_PLM_P140916_05275=1',#Menu button issue in answers.com
#            'S_RENDERER_DIED_NOTIFICATION=1', # Flag to relying on ANDROID framework callback for died notification.
            'S_PLM_P140918_04503 =1', # Avoid repaints on subpixel layer location change
            'S_PLM_P141016_02146 =1', # Change BreakingContext to use right dir for width
            'S_PLM_P141020_04434 =1', # Limiting the size of IPC message
        ],
      }],
