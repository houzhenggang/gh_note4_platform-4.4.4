...
public class ProxyChangeListener {
    ...
    private static class ProxyConfig {
        public ProxyConfig(String host, int port, String bypass) {
            mHost = host;
            mPort = port;
            mBypass = bypass;
        }
    ...
    private class ProxyReceiver extends BroadcastReceiver {
        ...
        private ProxyConfig extractNewProxy(Intent intent) {
            try {
                ...
                String bypass = (String) getExclusionListMethod.invoke(props);
                return new ProxyConfig(host, port, bypass);
    ...
    private void proxySettingsChanged(ProxyConfig cfg) {
        ...
        if (cfg != null) {
            nativeProxySettingsChangedTo(mNativePtr, cfg.mHost, cfg.mPort, cfg.mBypass);
        } else {
