...
public class AndroidCertVerifyResult {
    // for sending certificate error msg to MDM module
    public static interface AndroidCertVerifyObserver {
        public void notify(int status);
    }
    private static AndroidCertVerifyObserver sAndroidCertVerifyObserver = null;

    public static void setAndroidCertVerifyObserver(AndroidCertVerifyObserver ob) {
        sAndroidCertVerifyObserver = ob;
    }
    /**
    ...
    public AndroidCertVerifyResult(int status) {
        ...
        if (sAndroidCertVerifyObserver != null)
            sAndroidCertVerifyObserver.notify(status);
    }
