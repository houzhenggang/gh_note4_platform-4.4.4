...
public class X509Util {
    ...
    // SAMSUNG : certificate_revocation start >>
    public static interface ExtraCertificateErrorChecker {
        /*
         * return a value in CertVerifyStatusAndroid.java
         */
        public int check(CertificateException e);
    }
    
    private static ExtraCertificateErrorChecker extraCertificateErrorChecker = null;

    public static void setExtraCertificateErrorChecker(ExtraCertificateErrorChecker checker) {
        extraCertificateErrorChecker = checker;
    }
    // SAMSUNG : certificate_revocation end <<
        ...
        synchronized (sLock) {
            ...
            try {
                ...
                try {
                    ...
                    // SAMSUNG : certificate_revocation start >>
                    if (extraCertificateErrorChecker != null)
                        return new AndroidCertVerifyResult(extraCertificateErrorChecker.check(eDefaultManager));
                    // SAMSUNG : certificate_revocation end <<
                    return new AndroidCertVerifyResult(
