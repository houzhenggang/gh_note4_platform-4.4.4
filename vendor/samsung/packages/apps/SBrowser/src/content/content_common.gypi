...

{
  ...
  'sources': [
    ...
    'common/push_registration/push_registration_messages.h',
  ...
  'conditions': [
    ...
    ['OS=="android"',{
      'sources': [
        'common/gpu/client/gpu_memory_buffer_impl_android_sec.cc',
        'common/gpu/client/gpu_memory_buffer_impl_android_sec.h',
        'common/gpu/client/graphic_buffer_sec.cc',
        'common/gpu/client/graphic_buffer_sec.h',
      ],
      'link_settings': {
        'libraries': [
