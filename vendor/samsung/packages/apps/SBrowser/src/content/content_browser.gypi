...

{
  ...
  'sources': [
    ...
    'public/browser/push_permission_context.h',
    ...
    'browser/push_registration/push_provider.h',
    'browser/push_registration/push_registration_message_filter.cc',
    'browser/push_registration/push_registration_message_filter.h',
  ...
  'conditions': [
    ['enable_s_android_browser==1', {
      'include_dirs': [
        '<(INTERMEDIATE_DIR)',
        '<(SHARED_INTERMEDIATE_DIR)/sbr_content',
      ],
      'dependencies': [
    ...
    ['enable_devtools==0', {
	      'sources/': [
	        	['exclude', '^browser/devtools'],
	        	['exclude', 'public/browser/devtools_agent_host.h'],
	        	['exclude', 'public/browser/devtools_client_host.h'],
	        	['exclude', 'public/browser/devtools_external_agent_proxy.h'],
	        	['exclude', 'public/browser/devtools_external_agent_proxy_delegate.h'],
	        	['exclude', 'public/browser/devtools_frontend_host_delegate.h'],
	        	['exclude', 'public/browser/devtools_http_handler.h'],
	        	['exclude', 'public/browser/devtools_http_handler_delegate.h'],
	        	['exclude', 'public/browser/devtools_manager.h'],
	        	['exclude', 'public/browser/devtools_target.h'],
	        	['exclude', 'public/browser/android/devtools_auth.h'],
	        	['exclude', 'browser/android/devtools_auth.cc'],
	        	['exclude', '<(SHARED_INTERMEDIATE_DIR)/webkit/grit/devtools_resources.h'],
	        	['exclude', '<(SHARED_INTERMEDIATE_DIR)/webkit/grit/devtools_resources_map.cc'],
	        	['exclude', '<(SHARED_INTERMEDIATE_DIR)/webkit/grit/devtools_resources_map.h'],
	        	['exclude', '<(SHARED_INTERMEDIATE_DIR)/content/browser/devtools/devtools_protocol_constants.cc'],
	        	['exclude', '<(SHARED_INTERMEDIATE_DIR)/content/browser/devtools/devtools_protocol_constants.h'],  	        	
	        ],
      },{ # Dev tools enabled
	      'dependencies': [
	        'browser/devtools/devtools_resources.gyp:devtools_resources',
