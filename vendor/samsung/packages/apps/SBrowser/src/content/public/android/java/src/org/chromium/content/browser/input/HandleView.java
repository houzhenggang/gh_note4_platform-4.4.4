...
public class HandleView extends View {
    ...
    protected final CursorController mController;
    protected boolean mIsDragging;
    protected float mTouchToWindowOffsetX;
    protected float mTouchToWindowOffsetY;

    protected final int mLineOffsetY;
    private float mDownPositionX, mDownPositionY;
    private long mTouchTimer;
    protected boolean mIsInsertionHandle = false;
    private float mAlpha;
    private long mFadeStartTime;

    protected final View mParent;
    protected InsertionHandleController.PastePopupMenu mPastePopupWindow;
    ...
    protected HandleView(CursorController controller, int pos, View parent,
    ...
    protected void setOrientation(int pos) {
        int handleWidth;
        switch (pos) {
            case LEFT: {
    ...
    protected boolean isPositionVisible() {
    ...
    protected int getAdjustedPositionX() {
    ...
    // to the handles "parent" view.
    protected int getAdjustedPositionY() {
    ...
    // the root view of the application.
    protected int getRootViewRelativePositionY() {
    ...
    protected int getLineAdjustedPositionY() {
    ...
    protected void showPastePopupWindow() {
