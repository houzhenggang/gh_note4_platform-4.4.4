        ...
        ChildProcessConnection.DeathCallback deathCallback =
            new ChildProcessConnection.DeathCallback() {
                ...
                public void onChildProcessDied(int pid) {
                    ...
                    Log.i(TAG, "[onChildProcessDied] pid = "+pid);
                    stop(pid);
                }
            };
...
/*		
        // Notifying browser process about renderer died
        Log.i(TAG, "[stop]  process is killed by android framework in OOM or crashed pid = " + pid);
        nativeOnChildProcessDied(pid);
*/
        // comment end
...
/*
//Notifying browser process about renderer died
    private static native void nativeOnChildProcessDied(int pid);
//comment end
*/
