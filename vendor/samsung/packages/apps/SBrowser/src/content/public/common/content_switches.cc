...
// Suspend drawing when page load starts for certain period of time. This
// reduces power consumption.
const char kPageLoadSuspendDrawTime[]       = "page-load-suspend-draw-time";
...
//Command line switch for soft bitmap scale down in render process
const char kSoftBitmapScaleFraction[]="soft-bitmap-scale-fraction";
