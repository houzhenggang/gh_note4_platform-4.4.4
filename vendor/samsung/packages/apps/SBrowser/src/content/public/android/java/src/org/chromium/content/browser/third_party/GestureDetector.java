...
*/
        ...
        case MotionEvent.ACTION_DOWN:
            ...
            if (mIsLongpressEnabled) {
                ...
                mHandler.sendEmptyMessageAtTime(LONG_PRESS, mCurrentDownEvent.getEventTime()
                        + TAP_TIMEOUT + LONGPRESS_TIMEOUT);
            }
            mHandler.sendEmptyMessageAtTime(SHOW_PRESS, mCurrentDownEvent.getEventTime() + TAP_TIMEOUT);
