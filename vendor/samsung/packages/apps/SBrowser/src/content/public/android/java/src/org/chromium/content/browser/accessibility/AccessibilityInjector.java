...
public class AccessibilityInjector extends WebContentsObserverAndroid {
    ...
    public void setScriptEnabled(boolean enabled) {
        ...
        if ( (!accessibilityIsAvailable() && !mInjectedScriptEnabled) || mInjectedScriptEnabled == enabled) return;
    ...
    private static class TextToSpeechWrapper {
        ...
        /**
         * Removed the Support for braille
         */
         Log.w(TAG," Removed Support for braille Devices @samsung");
        }
