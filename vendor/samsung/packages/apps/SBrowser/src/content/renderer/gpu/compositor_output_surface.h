...
class CompositorOutputSurface
 ...
 public:
  ...
  //Notifies app, when the renderer intialization is complete
  virtual void OnRendererInitializeComplete() OVERRIDE;
  void OnSetTopControlsHeight(int top_controls_height);
#endif
#if defined(S_SET_SCROLL_TYPE)
  void OnSetScrollType(int type);
#endif
#if defined(SBROWSER_HIDE_URLBAR_EOP)
  virtual void UpdateEndOfPageState( bool eop_state ) OVERRIDE;
#endif
