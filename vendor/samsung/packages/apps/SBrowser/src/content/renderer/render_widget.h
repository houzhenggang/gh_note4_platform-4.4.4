...
class CONTENT_EXPORT RenderWidget
 ...
 protected:
  ...
  void OnDefersLoading(bool defer);
#endif
  ...
  // Close Select popup if it doesnt have items.
  void SendClosePopup();
  ...
  void UpdateTextInputStateForReset(bool show_ime_if_needed,bool send_ime_ack) ;
#endif
#endif
  ...
  // Whether the page was consuming a touch move event after
  // the previous touch start event.
  bool seen_processed_touch_move_;
