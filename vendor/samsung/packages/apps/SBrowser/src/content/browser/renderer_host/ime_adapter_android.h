...
class ImeAdapterAndroid {
 public:
  ...
  void SetComposingTextWithSubComposingRegion(JNIEnv*, jobject, jstring text, int new_cursor_pos, int new_region_start, int new_regsion_end, int backgroundColor);
  ...
  void FocusedNodeChanged(bool is_editable_node,bool is_select_node);
  void DefersLoading(JNIEnv* env, jobject, jboolean defer);
  void RequestUpdateIME(JNIEnv* env, jobject, jboolean show_ime_if_needed, jboolean send_ime_ack );
