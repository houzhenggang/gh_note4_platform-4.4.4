...
class ChildProcessLauncher::Context
 ...
 public:
  ...
  void Launch(
    ...
    LOG(INFO)<<"[Renderer][Startup] ChildProcessLauncher::Launch";
#endif
    client_ = client;
...
#if defined(S_RENDERER_START_EXIT_LOGGING)
    LOG(INFO)<<"[Renderer][Startup] ChildProcessLauncher::OnChildProcessStarted " << handle;
#endif
...
#if defined(OS_ANDROID)
#if defined(S_RENDERER_START_EXIT_LOGGING)
    LOG(INFO)<<"[Renderer][Exit] ChildProcessLauncher::TerminateInternal " << handle;
#endif
