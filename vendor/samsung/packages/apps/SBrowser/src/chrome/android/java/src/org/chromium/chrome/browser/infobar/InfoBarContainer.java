...
public class InfoBarContainer extends LinearLayout {
    ...
    protected static class InfoBarTransitionInfo {
    ...
    protected final ArrayDeque<InfoBarTransitionInfo> mInfoBarTransitions;
    ...
    public InfoBarContainer(Activity activity, AutoLoginProcessor autoLoginProcessor,
        ...
        /* SAMSUNG CHANGE 
         * S BROWSER 2.0 Tablet support URL bar hide functionality same as phone. 
         * So, we've changed location of infobar to bottom. */
        mInfoBarsOnTop = false; 
    ...
    protected void processPendingInfoBars() {
