...
public class SbrContentVideoView extends FrameLayout
    ...
    protected void setOverlayVideoMode(boolean enable) {
        ...
        if (mActivityController != null) {
            setIsOverlayVideoMode(enable);
            mActivityController.setOverlayVideoMode(enable);
        }
    }

    public static void setIsOverlayVideoMode(boolean isOverlayVideoMode){
        sIsOverlayVideoMode = isOverlayVideoMode;
    }
    
    public static boolean isOverlayVideoMode(){
        return sIsOverlayVideoMode;
    }
