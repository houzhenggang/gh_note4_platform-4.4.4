 ...
 */
public class SbrContentVideoViewLegacy extends SbrContentVideoView {
    ...
    SbrContentVideoViewLegacy(Context context, long nativeContentVideoView,
    ...
    protected void openVideo() {
        ...
        mMediaController.setMediaPlayer(new MediaController.MediaPlayerControl() {
            ...
            public int getCurrentPosition() {
                return SbrContentVideoViewLegacy.this.getCurrentPosition();
            }

            @Override
            public int getDuration() {
                return SbrContentVideoViewLegacy.this.getDuration();
            }

            @Override
            public boolean isPlaying() {
                return SbrContentVideoViewLegacy.this.isPlaying();
            }

            @Override
            public void pause() {
                SbrContentVideoViewLegacy.this.pause();
            }

            @Override
            public void seekTo(int pos) {
                SbrContentVideoViewLegacy.this.seekTo(pos);
            }

            @Override
            public void start() {
                SbrContentVideoViewLegacy.this.start();
            }
        });
