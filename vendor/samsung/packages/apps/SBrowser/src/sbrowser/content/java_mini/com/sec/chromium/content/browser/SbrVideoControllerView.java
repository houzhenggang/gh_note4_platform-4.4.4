...
public class SbrVideoControllerView extends FrameLayout {
    ...
    public SbrVideoControllerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mRoot = null;
        mContext = context;
    ...
    public SbrVideoControllerView(Context context, boolean useFastForward) {
        super(context);
        mContext = context;
    ...
    public void setMediaPlayer(MediaPlayerControl player) {
        ...
        if(mWFDManager != null)
            mWFDManager.setMediaPlayer(player);
    }
    ...
    public void show(int timeout) {
        ...
        if (!mShowing && mAnchor != null) {
            ...
            if (timeout != 0) {
                Animation translateOn = null;
                translateOn = new TranslateAnimation(0, 0, mRoot.findViewById(R.id.controller_layout).getHeight(), 0);
                if (mForced) translateOn.setDuration(100);
                else translateOn.setDuration(500);
        ...
        public boolean onTouch(View view, MotionEvent event) {
            switch (event.getAction()) {
                case MotionEvent.ACTION_UP:
                    ...
                    //activity.startActivity(new Intent(activity, SbrDeviceDiscoverActivity.class));

                    //mCastManager.showDevicePopup();

                    mWFDManager.scanWifiDisplays();
                    mWFDManager.showDevicePopup(mPlayer.isPlaying());
    ...
    public void disconnectWifiDisplay(){
        mWFDManager.disconnectWifiDisplay();
    }
}