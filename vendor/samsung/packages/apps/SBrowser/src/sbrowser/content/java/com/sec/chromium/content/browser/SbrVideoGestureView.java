...
public class SbrVideoGestureView {
    ...
    private void initGestureView() {
        ...
        mBrightnessSeekBar = (TwSeekBar) mGestureView.findViewById(R.id.brightness_gesture_seekbar);
        ...
        mVolumeSeekBar = (TwSeekBar) mGestureView.findViewById(R.id.volume_gesture_seekbar);
    ...
    private void setAutoBrightnessDetailText(int level) {
        ...
        int mHalfLevel = mBrightUtil.getMaxBrightness() / 2;
        mAutoBrightDetailLevel = (mAutoBrightDetailLevel - mHalfLevel) / AUTO_BRIGHT_DETAIL_LEVEL_STEP_VAL;
        if (mAutoBrightDetailLevel > 0)
            text.append('+');
    ...
    private void setBrightnessBarVisible() {
        ...
        if (mBrightnessPopup != null && mGestureView != null) {
            ...
            int gravity = GeneralUtil.isTablet() == true ? (Gravity.START | Gravity.CENTER_VERTICAL):(Gravity.START | Gravity.TOP);
    ...
    private void setVolumeBarVisible() {
        ...
        if (mVolumePopup != null && mGestureView != null) {
            ...
            int gravity = GeneralUtil.isTablet() ? (Gravity.END | Gravity.CENTER_VERTICAL) : (Gravity.END | Gravity.TOP);
    ...
    private class VideoBrightnessUtil {
        ...
        private void setBrightness(int level) {
            ...
            if (mSystemBrightnessLevel < GESTURE_ADJUSTMENT_BRIGHTNESS_THRESHOLD_ENDS
        ...
        private boolean isFolderType() {
            if (mContext != null && mContext.getPackageManager() != null) {
                return mContext.getPackageManager().hasSystemFeature(PackageManager.FEATURE_FOLDER_TYPE);
            }
            return false;
        }
    }
