...
public class SbrAndroidProtocolHandler {
    ...
    public static String getMimeType(Context context, InputStream stream, String url) {
        ...
        if (uri.getScheme().equals(CONTENT_SCHEME)) {
            Log.i("SavePage","SavePage :: getMimeType::"+context.getContentResolver().getType(uri));
            String mimeType = URLConnection.guessContentTypeFromName(path);
            Log.i("SavePage","SavePage :: mimeType :: "+mimeType);
            if(null == context.getContentResolver().getType(uri))
                return "multipart/related"; //context.getContentResolver().getType(uri);
            else
        ...
        try {
            Log.i("SavePage","SavePage :: mimeType fallback :: "+URLConnection.guessContentTypeFromStream(stream));
