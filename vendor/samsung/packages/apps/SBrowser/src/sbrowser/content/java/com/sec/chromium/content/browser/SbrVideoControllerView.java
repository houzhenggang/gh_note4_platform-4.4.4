...
public class SbrVideoControllerView extends FrameLayout {
    ...
    public SbrWifiDisplayManager getWFDManager(){
        return mWFDManager;
    }
    ...
    public void updateClosedCaptionBtn(int status){
        ...
        switch(status){
            ...
            case CLOSED_CAPTION_SHOWING:
                ...
                mCaptionBtn.setBackgroundResource(R.drawable.mediaplayer_closedcaption_down);
                break;
            case CLOSED_CAPTION_HIDDEN:
                mCaptionBtn.setVisibility(View.VISIBLE);
                mCaptionBtn.setBackgroundResource(R.drawable.mediaplayer_closedcaption);
                break;
            default:
                break;
        }
    ...
    private class SbrVideoTitleControllerView extends RelativeLayout {
        ...
        private TwSeekBar mVolumeSeekBarPopup = null;
        ...
        private void initControllerView(View v) {
            ...
            mWfdBtn = (ImageButton)v.findViewById(R.id.allshare);            
            ...
            mVolumeSeekBarPopup = (TwSeekBar) mVolPopupLayout.findViewById(R.id.vol_seekbar_popup);
            ...
            if (mVolumeBtn != null) {
                ...
                if (getCurrentVolume() == 0) {
                    mVolumeBtn.setBackgroundResource(R.drawable.btn_volume_mute);
                } else {
                    mVolumeBtn.setBackgroundResource(R.drawable.btn_volume);
                }
            ...
            if (mVolumeSeekBarPopup != null) {
                mVolumeSeekBarPopup.setOnTwSeekBarChangeListener(mVolumeSeekBarChangeListenerpopup);
        ...
        private TwSeekBar.OnTwSeekBarChangeListener mVolumeSeekBarChangeListenerpopup = new TwSeekBar.OnTwSeekBarChangeListener() {
            @Override
            public void onProgressChanged(TwSeekBar seekBar, int progress, boolean fromTouch) {
                if (fromTouch) {
                    setVolume(progress);
            ...
            @Override
            public void onStartTrackingTouch(TwSeekBar arg0) {
            }
            @Override
            public void onStopTrackingTouch(TwSeekBar arg0) {
                hideVolumeBarPopup();
            }
        };
