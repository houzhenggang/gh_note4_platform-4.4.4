...
static const char ikev2_proposal[] = 
  "aes256gcm16-aes128gcm16-aes256gcm12-aes128gcm12-aes256gcm8-aes128gcm8-aes256-aes128-sha512-sha2_384-sha2_256-sha1_160-sha1-"
  "modp2048s256-ecp384-ecp256-modp2048-modp1536";

static const char child_proposal[] = 
  "aes256gcm16-aes128gcm16-aes256gcm12-aes128gcm12-aes256gcm8-aes128gcm8-aes256-aes128-sha512-sha2_384-sha2_256-sha1_160-sha1-"
  "modp2048s256-ecp384-ecp256-modp2048-modp1536";
...
{ 
  proposal_t* proposal = proposal_create_from_string(PROTO_ESP, child_proposal);
  if (!proposal)
    {
...
{
  proposal_t* proposal = proposal_create_from_string(PROTO_IKE, ikev2_proposal);
  if(!proposal)
    {
