...
#ifndef ANDROID
	/*In Android init is monitoring does charon process exist or not.
	  Using pid file is anyway risky, because the user have no way to 
	  delete possible orphaned pid file. */
	if (check_pidfile())
	{
